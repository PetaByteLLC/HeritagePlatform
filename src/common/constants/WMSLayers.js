export const WMSLayers = [
    ...
    { title: 'Heritage protection', workspace: 'Heritage', layerName: 'heritage_protection_layer', style: 'heritage_protection_layer', tiled: true, visible: true, min: 5, max: 15, tileSize: 256, zIndex: 4},
];